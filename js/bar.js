function Bar(tourData, reducedCityData, reducedStateData) {
    var self = this;
...
Bar.prototype.init = function() {
    ...
    self.svg1 = d3.select("#barchart-area").append("svg")
        .attr("id", "bar1-svg")
        .attr("height", self.height/2)
        .attr("width", self.width);
        // .attr("transform", "translate(0, 100)");

    self.svg2 = d3.select("#barchart-area").append("svg")
        .attr("id", "bar2-svg")
        .attr("height", self.height/2)
        .attr("width", self.width);
        // .attr("transform", "translate(0, 100)");
...
Bar.prototype.update = function(tourData, reducedCityData, reducedStateData){
    var self = this;
...
Bar.prototype.renderBar = function(reducedCityData) {
    var self = this;
...
Bar.prototype.renderRevenue = function(reducedCityData) {
    var self = this;
...
Bar.prototype.renderAttendance = function(reducedCityData) {
    var self = this;
